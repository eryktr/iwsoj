...
|
| If public test fails, the user will see **INCORRECT_SOLUTION**. That is an information about user's output for the tested task's input and expected output.
|
...
| The source code is tested as follows:

- program checks if the user source code was compiled correctly for the input from table named **tasks_task** from the database
